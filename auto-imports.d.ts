...
declare global {
  ...
  const chatState: typeof import('./src/core/store/chat.store')['chatState']
  ...
  const getUserService: typeof import('./src/core/store/chat.store')['getUserService']
  ...
  const resetUser: typeof import('./src/core/store/chat.store')['resetUser']
  const setActiveDialog: typeof import('./src/core/store/chat.store')['setActiveDialog']
  const setFilter: typeof import('./src/core/store/chat.store')['setFilter']
