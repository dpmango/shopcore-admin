...
declare global {
  ...
  const fetchOperatorStatsApi: typeof import('./src/core/api/stat.api')['fetchOperatorStatsApi']
  const fetchOperatorsApi: typeof import('./src/core/api/stat.api')['fetchOperatorsApi']
  ...
  const getOperatorDetailsService: typeof import('./src/core/store/stats.store')['getOperatorDetailsService']
